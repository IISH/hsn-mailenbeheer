...
qx.Class.define("hsnmailenbeheer.Application",
    {
        ...
        members: {
            ...
            getHsnOpData: function (ev) {
                ...
                {
                    url += '/';
                }               // required: POST + Django: APPEND_SLASH
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (this.opinfo_valid) {
                            ...
                            if (statustekst.length > 0) {
                                this.label_opstatus.set({backgroundColor: this.color_Yellow});
                            }
            ...
            createWindow0: function () {
                ...
                containerOpnum.addListener("appear", function () {
                    inputOpnum.focus();
                }, containerOpnum);
            ...
            createWindow1: function () {
                    ...
                    function (ev) {
                        ...
                        if (editable) {
                            ...
                            if (death_list.length == 0 || ( day == 0 && month == 0 && year == 0 )) {
                                ...
                                labelDeathLegend.setValue("Overlijdensdatum is bekend");
                            }
                        }
                        else {
                        ...
                        if (phase_a_str === "") {
                            ...
                            comboboxPhaseA.setValue(phase_a_str);
                        }
                        ...
                        if (phase_b_str === "") {
                            ...
                            comboboxPhaseB.setValue(phase_b_str);
                        }
                        ...
                        if (phase_c_str === "") {
                            ...
                            comboboxPhaseC.setValue(phase_c_str);
                        }
                        ...
                        if (phase_b_id == 2 || phase_b_id == 3 || phase_b_id == 7 || phase_b_id == 8 || phase_b_id == 9) {
                            ...
                            buttonMissing.setEnabled(false);
                        }
                    },
                    this
                );
                ...
                var textfieldDeathDay = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "DD",
                    textAlign: "center"
                });
                var textfieldDeathMonth = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "MM",
                    textAlign: "center"
                });
                var textfieldDeathYear = new qx.ui.form.TextField().set({
                    width: 40,
                    placeholder: "JJJJ",
                    textAlign: "center"
                });
            ...
            createWindow1Missing: function () {
                ...
                var textfieldBeginDay = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "DD",
                    textAlign: "center"
                });
                var textfieldBeginMonth = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "MM",
                    textAlign: "center"
                });
                var textfieldBeginYear = new qx.ui.form.TextField().set({
                    width: 40,
                    placeholder: "JJJJ",
                    textAlign: "center"
                });
                ...
                textfieldBeginYear.addListener("input", function (ev) {
                    ...
                    if (year != '-' && isNaN(year)) {
                        ...
                        textfieldEndDay.focus();
                    }             // OK, next field
                });

                var textfieldEndDay = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "DD",
                    textAlign: "center"
                });
                var textfieldEndMonth = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "MM",
                    textAlign: "center"
                });
                var textfieldEndYear = new qx.ui.form.TextField().set({
                    width: 40,
                    placeholder: "JJJJ",
                    textAlign: "center"
                });
                ...
                for (var s = 0; s < strings.length; s++) {
                    var string = strings[s].id + " - " + strings[s].text;
                    var listItem = new qx.ui.form.ListItem(string);
                    if (string === "2 - Code niet in gebruik") {
                        listItem.setEnabled(false);
                    }
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (radiobuttonNo.getValue() == true) {
                            var isFinal = "n";
                        }
                        else {
                            var isFinal = "j";
                        ...
                        for (var r = 0; r < nrows; r++)    // get max value of volgnr's
                        {
                            ...
                            if (idvolgnr_row > idvolgnr_max) {
                                idvolgnr_max = idvolgnr_row
                            }
                        }
            ...
            createWindow2: function () {
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (value == true) {
                            textfieldDepart.setEnabled(true);
                        }
                        else {
                            textfieldDepart.set({value: "", enabled: false});
                        }
                    },
                    this
                );
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (value == true) {
                            textfieldArrive.setEnabled(true);
                        }
                        else {
                            textfieldArrive.set({value: "", enabled: false});
                        }
                    },
                    this
                );
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (value == true) {
                            textfieldPeriod.setEnabled(true);
                        }
                        else {
                            textfieldPeriod.set({value: "", enabled: false});
                        }
                    },
                    this
                );
                ...
                var textfieldDepart = new qx.ui.form.TextField().set({
                    width: 200,
                    placeholder: "DD/MM/JJJJ",
                    textAlign: "left",
                    enabled: true
                });
                var textfieldArrive = new qx.ui.form.TextField().set({
                    width: 200,
                    placeholder: "DD/MM/JJJJ",
                    textAlign: "left",
                    enabled: false
                });
                var textfieldPeriod = new qx.ui.form.TextField().set({
                    width: 200,
                ...
                var textareaRemarks = this.__textareaRemarks = new qx.ui.form.TextArea().set({
                    width: 622,
                    height: 120,
                    allowGrowX: false,
                    allowGrowY: true,
                ...
                (
                    ...
                    function (ev) {
                        ...
                        if (radiobuttonParents.getValue()) {
                            info_journey = 3;
                        }
                        else if (radiobuttonPartner.getValue()) {
                            info_journey = 2;
                        }
                        else if (radiobuttonAlone.getValue()) {
                            info_journey = 1;
                        }
                        ...
                        if (textfield1Father.isEnabled()) {
                            op_father = textfield1Father.getValue();
                        }
                        else if (textfield2Father.isEnabled()) {
                            op_father = textfield2Father.getValue();
                        }
                        else {
                            op_father = "";
                        }

                        if (textfield1Mother.isEnabled()) {
                            op_mother = textfield1Mother.getValue();
                        }
                        else if (textfield2Mother.isEnabled()) {
                            op_mother = textfield2Mother.getValue();
                        }
                        else {
                            op_mother = "";
                        }

                        if (combobox1Partner.isEnabled()) {
                            op_partner = combobox1Partner.getValue();
                        }
                        else if (combobox2Partner.isEnabled()) {
                            op_partner = combobox2Partner.getValue();
                        }
                        else {
                            op_partner = "";
                        }
                        ...
                        if (textfieldDepart.isEnabled()) {
                            kind = "V";
                            date = textfieldDepart.getValue();
                        }
                        if (textfieldArrive.isEnabled()) {
                            kind = "H";
                            date = textfieldArrive.getValue();
                        }
                        if (textfieldPeriod.isEnabled()) {
                            kind = "B";
                            period = textfieldPeriod.getValue();
                        }
                        ...
                        for (var i = 0; i < this.OP.op_info_list.length; i++) {
                            ...
                            if (op_info.id_origin == 10)   // birth op_info
                            {
                                ...
                                if (op_info.rp_prefix != "") {
                                    op_ident += ", " + op_info.rp_prefix;
                                }
            ...
            createWindow3: function () {
                ...
                var textfieldMarriage = new qx.ui.form.TextField().set({
                    width: 200,
                    placeholder: "DD/MM/JJJJ",
                    textAlign: "left",
                    enabled: true
            ...
            createWindow6: function () {
                ...
                var textfieldMutationDay = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "DD",
                    textAlign: "center"
                });
                var textfieldMutationMonth = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "MM",
                    textAlign: "center"
                });
                var textfieldMutationYear = new qx.ui.form.TextField().set({
                    width: 40,
                    placeholder: "JJJJ",
                    textAlign: "center"
                });
                ...
                checkboxLastname.addListener("execute", function (ev) {
                    if (checkboxLastname.get("value") == true) {
                ...
                checkboxPrefix.addListener("execute", function (ev) {
                    if (checkboxPrefix.get("value") == true) {
                        textfieldPrefix.setEnabled(true);
                    }
                    else {
                ...
                checkboxFirstname.addListener("execute", function (ev) {
                    if (checkboxFirstname.get("value") == true) {
                ...
                checkboxBirthplace.addListener("execute", function (ev) {
                    if (checkboxBirthplace.get("value") == true) {
                        comboboxBirthplace.setEnabled(true);
                    }
                    else {
                        comboboxBirthplace.setEnabled(false);
                    }
                });

                checkboxGender.addListener("execute", function (ev) {
                    if (checkboxGender.get("value") == true) {
                ...
                var textfieldBirthDay = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "DD",
                    textAlign: "center",
                    enabled: false
                });
                var textfieldBirthMonth = new qx.ui.form.TextField().set({
                    width: 30,
                    placeholder: "MM",
                    textAlign: "center",
                    enabled: false
                });
                var textfieldBirthYear = new qx.ui.form.TextField().set({
                    width: 40,
                    placeholder: "JJJJ",
                    textAlign: "center",
                    enabled: false
            ...
            createLogin: function () {
                ...
                var window = this.__windowLogin = new qx.ui.window.Window("HSN - Mail en Beheer -- LDAP/Jira Login").set({
                    modal: true,
                    width: 255,
            ...
            createLogout: function (ev) {
                ...
                var window = this.__windowLogout = new qx.ui.window.Window("HSN - Mail en Beheer -- Logout").set({
                    modal: true,
                    width: 255,
                    contentPadding: [20, 20, 20, 20],
                    showMinimize: false,
