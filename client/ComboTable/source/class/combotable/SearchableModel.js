...
/**
 * Add searchString property to the Simple model. 
 * The searching will always happen on the second column.
 */
qx.Class.define
( "combotable.SearchableModel", 
  {
    ...
    members : 
    {
      ...
      {
        //console.debug( "combotable.SearchableModel/setData()" );
        //console.debug( rowArr );
        if ( ! filtered ) { this.__allRows = rowArr; }
