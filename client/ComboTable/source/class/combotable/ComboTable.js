...
/**
 * If a traditional selectbox covers lots of options, it becomes pretty unpractical
  ...
  "combotable.ComboTable", 
  {
    ...
    members : 
    {
      ...
      __makeTable : function() 
      {
        ...
        // FL-19-Oct-2015, Qooxdoo 3.5.1 -> 4.0.2: 
        // focusCellOnMouseMove -> focusCellOnPointerMove
        table.set({
      ...
      // overridden
      _onPopupChangeVisibility : function( ev ) 
      {
        var visibility = ev.getData();
      ...
      _onTextFieldInput : function( ev ) 
      {
        ...
        this.__updateTimer = this.__timerMgr.start
        ( 
        ...
        this.fireDataEvent( "input", value, ev.getOldData() );
      },
    
    
      // overridden
      _onTextFieldChangeValue : function( ev ) 
      {
