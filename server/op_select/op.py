...
#from mail.models import Gbhsnttl, Gdhsnttl, HsnIdmut, Hsnrp, Huwknd
from mail.models import HsnIdmut, Hsnrp, Huwknd
...
def get_op_info( op_number ):
	...
	*_firstname is actually firstnames
	...
	try:
		hsnrp_qs = Hsnrp.objects.filter( idnr = op_number )
...
#	print( "op/get_id_change_auto:", op_number )
	...
	try:
		info = Hsnrp.objects.get( idnr = op_number )
		...
		print( "op/get_op_did_info( op_number()" )
		type, value, tb = exc_info()
		msg = "Hsnrp.objects.get failed: %s" % value
		print( "%s\n" % msg )
